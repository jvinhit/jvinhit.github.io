...
> **Mô hình tư duy:** LLM thuần giống thi **không được mở tài liệu** —
> trả lời bằng trí nhớ, gặp câu ngoài vùng đã học thì *bịa* cho trôi.
> RAG biến nó thành thi **mở sách**: tìm đúng trang, đặt lên bàn, rồi
> mới trả lời. Model không cần "nhớ" nhiều hơn — nó cần **tra cứu** tốt
> hơn. Phần lớn công sức build RAG là làm cho bước "tìm đúng trang" thật
> chính xác.
