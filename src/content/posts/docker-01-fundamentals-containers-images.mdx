...
Đây là **Phần 1 của series 10 bài** đưa bạn từ "mới nghe Docker" đến tự tin build, chạy, harden và *debug* ứng dụng container qua **Docker → Compose → Kubernetes**. Mỗi phần đều kết thúc bằng **bài tập**; hãy làm, đừng chỉ đọc.
