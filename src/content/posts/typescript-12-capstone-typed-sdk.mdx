...
- Tiếp tục với [chặng TypeScript Type Challenges](/blog/typescript-type-challenges-explained/) để luyện type mechanics có chọn lọc.
- Sau đó chuyển sang [chặng Design Patterns in TypeScript](/blog/ts-pattern-01-singleton-module/) để mở rộng vốn pattern.
