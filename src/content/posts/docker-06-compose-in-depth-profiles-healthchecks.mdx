...
description: 'Đào sâu Compose với interpolation, healthcheck, profiles, override files, scale và restart policy qua các lab có thể chạy.'
pubDate: 2025-10-06
...
Đây là **Phần 6 của chặng nền tảng** về Docker → Compose → Kubernetes. Ở [Phần 5](/blog/docker-05-compose-fundamentals/) bạn đã khai báo stack nhiều dịch vụ trong `compose.yaml` và bật bằng `docker compose up`. Mỗi phần kết thúc bằng **bài tập**; hãy làm, đừng chỉ đọc.
