...
> **Hình dung nhanh**: embedding giống **toạ độ GPS cho ý nghĩa**. Mỗi
> từ, câu, hay tấm ảnh được đặt vào một điểm trong không gian nhiều
> chiều; thứ gì gần nghĩa thì nằm gần nhau, thứ gì khác nghĩa thì cách
> xa. Mọi phép semantic search, gợi ý, hay gom cụm bên dưới thực ra chỉ
> là **đo khoảng cách giữa các toạ độ** đó.
