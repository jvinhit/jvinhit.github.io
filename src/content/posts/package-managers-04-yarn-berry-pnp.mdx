...
Đây là **Phần 4 của series 12 phần** về package manager Node. Ở [Phần 3](/posts/package-managers-03-yarn-classic) ta thấy Yarn Classic — một npm tốt hơn với *cùng* mô hình `node_modules`. **Yarn Berry** vứt bỏ hoàn toàn mô hình đó.
