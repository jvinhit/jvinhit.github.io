...
Đây là **Phần 2 của series 12 phần** về package manager Node. Ở [Phần 1](/posts/package-managers-01-mental-model) ta dựng mô hình tư duy — *resolve → fetch → link*. Giờ ta đào sâu **npm**, công cụ đi kèm Node và là chuẩn để mọi manager khác đối chiếu.
