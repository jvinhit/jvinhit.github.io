...
Đây là **Phần 8 của series 12 phần** về package manager Node. [Phần 7](/blog/package-managers-07-lifecycle-scripts-node-gyp) giải thích *vì sao* code native cần biên dịch và `node-gyp` làm ra sao. Phần này nói về việc tránh hẳn bước biên dịch — cách hệ sinh thái **ship binary prebuilt** — và bề mặt tấn công nó tạo ra.
