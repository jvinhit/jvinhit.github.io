...
> **Mô hình tư duy:** Fine-tune không phải "dạy model điều mới" — mà là
> **luyện cho nó thành thạo điều nó đã biết lờ mờ**. Giống tuyển một kỹ
> sư giỏi sẵn rồi cho đi học nghiệp vụ chuyên sâu của công ty: bạn không
> dạy lại lập trình, bạn mài giũa *phong cách* và *phản xạ*. Hệ quả thực
> tế: nếu thứ bạn cần là *kiến thức tra cứu được* thì đó là việc của RAG;
> fine-tune chỉ **specialize** capability đã có, gần như không **thêm**
> capability mới.
