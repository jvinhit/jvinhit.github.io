---
title: 'Three.js from Zero to Senior · Part 14 — Blender → glTF → Three.js: the Import Workflow'
...
- **Compression (Draco)** — **TẮT lúc này.** Bật thì loader *bắt buộc* có `DRACOLoader`, không thì import fail (để Part 16).
