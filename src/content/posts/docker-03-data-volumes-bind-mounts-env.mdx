...
Đây là **Phần 3 của series 10 bài** về Docker → Compose → Kubernetes. Ở [Phần 1](/blog/docker-01-fundamentals-containers-images/) bạn đã biết mỗi container đang chạy có một **layer ghi-được** mỏng trên các layer image chỉ-đọc; ở [Phần 2](/blog/docker-02-images-and-dockerfile/) bạn đã tự build image của mình.
