...
Đây là **Phần 3 của series 12 phần** về package manager Node. Ta đã đi qua [mô hình tư duy](/blog/package-managers-01-mental-model) và [npm chuyên sâu](/blog/package-managers-02-npm-deep-dive). Giờ là **Yarn Classic**, version 1.
