...
Đây là **Phần 7 của series 10 bài** về Docker → Compose → Kubernetes. Ở [Phần 2](/blog/docker-02-images-and-dockerfile/) bạn đã học **build** image — layer, cache, multi-stage, `.dockerignore`. Ở [Phần 6](/blog/docker-06-compose-in-depth-profiles-healthchecks/) bạn điều phối stack nhiều service với profile và health check.
