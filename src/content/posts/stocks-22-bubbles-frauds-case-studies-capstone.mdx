...
Đây là **Phần 22 — phần kết của volume nâng cao**, nối tiếp sau capstone Phần 12. Volume nâng cao đã dạy bạn chi phí (Phần 18), kỹ thuật nâng cao (Phần 19), đòn bẩy (Phần 20) và đầu tư quốc tế (Phần 21). Phần này hợp nhất _tất cả_ — cộng tâm lý đám đông (Phần 9), cơ bản (Phần 3) và rủi ro (Phần 8) — qua lăng kính mạnh mẽ nhất để học: **những thảm hoạ thật**. Bong bóng và gian lận là nơi mọi bài học của series bị _thử lửa_.
...
```text
  ...
  ────────────────────────────────────────────────────────────
  P12  CAPSTONE   → fuse fundamentals, technicals, risk, psychology
