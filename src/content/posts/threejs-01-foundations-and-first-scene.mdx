...
Chào mừng, gà mờ. Trong mười phần tới tôi sẽ đưa bạn từ "tôi dán một đoạn Three.js rồi cầu cho nó hiện ra" lên "tôi dựng, chiếu sáng, tối ưu và ship 3D real-time như một senior."
...
Một lệnh `renderer.render(scene, camera)` vẽ **một** frame. Muốn animation, bạn gọi nó mỗi frame qua `requestAnimationFrame`, thứ đồng bộ với tần số quét màn hình (thường 60 fps).
